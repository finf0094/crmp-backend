...
public class JwtService {
    ...
    private static final Duration REFRESH_TOKEN_EXPIRATION_TIME = Duration.ofSeconds(10);
    ...
    public Claims getAccessTokenClaims(String token) {
        try {
            ...
            throw new AuthenticationException("Token has expired", HttpStatus.UNAUTHORIZED);
